...
<!-- schema:taxonomy -->
regions: [ирлин, лускан, побережье-меча]
cities: [северный-келлер, южный-келлер, храм-ильматера]
factions: [культ-взирающих-очей, академия-огненные-ладони]
races: [дворф, эльф, человек, тифлинг, полурослик, дракон-рождённый]
classes: [паладин, друид, маг, колдун, плут, клерик, воин, варвар]
status-markers: [активный, выполненный, заморожен, проклятье]
mechanics: [mummy-rot, договор-души, обелиски, жаровни]
<!-- /schema:taxonomy -->
