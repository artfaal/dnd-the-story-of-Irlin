...
cities: [северный-келлер, южный-келлер, храм-ильматера, город, город-угасания, академия, академия-магии, огненные-ладони, арена, дом-прессы, библиотека, чайная, таверна, голодный-лесник, горный-лесник, ферма, ферма-самблео, заброшенная-лесопилка, кемп-орков, склеп, катакомбы, подземелье, руины, алтарь, лаборатория]
...
status-markers: [активный, заморожен, проклятие, срочно, главный-квест, побочный, выполнен, мёртв, мертва, погиб, квест, основная-локация, цель, враг]
